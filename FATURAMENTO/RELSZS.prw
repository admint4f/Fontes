...
±±ºPrograma  ³RELSZS    º Autor ³ AP6 IDE            º Data ³  21/06/06   º±±
...
Local cDesc3         := "Custos Operacionais"
Local cPict          := ""
Local titulo       := "Custos Operacionais"
Local nLin         := 80
                   //  123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890
Local Cabec1       := "CODIGO          SERVIÇO                          PREVISTO      REALIZADO    ANALISE     ARTISTA               IMOVEL "
Local Cabec2       := ""
Local imprime      := .T.
Local aOrd := {}
Private lEnd         := .F.
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÉÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍ»±±
±±ºFun‡„o    ³RUNREPORT º Autor ³ AP6 IDE            º Data ³  21/06/06   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
...
if ZS_CHAVE1 <> MV_PAR01
  ...
  loop
   ...
   @ nLin,01 psay SZS->ZS_CODIGO
   @ nLin,17 psay SZS->ZS_DESC
   @ nLin,50 psay SZS->ZS_PREVIST PICTURE "9,999,999.99"
   @ nLin,64 psay SZS->ZS_REALIZA PICTURE "9,999,999.99"
   @ nLin,77 psay SZS->ZS_CHAVE1 
   @ nLin,85 psay  ALLTRIM(SUBSTR(SZS->ZS_ARTISTA,1,25)) + "/" + ALLTRIM(SUBSTR(SZS->ZS_DESCRI,1,25))
//   @ nlin,111 psay 
